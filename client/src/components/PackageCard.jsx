  ...
  return (
    <div>
      ...
      >
        ...
        <h5 class="text-[30px] font-light font-normal -mt-2 ml-16 uppercase " >Trip Name</h5>
        <h3 className="text-2xl font-normal tracking-tight text-gray-900 dark:text-white flex mt-1 ml-0">
          Mumbai <FaArrowRightLong class="h-5 mx-2 mt-2"/>  Goa Plan
        </h3>
